...
void SpatialTransformerLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	dTheta_tmp_shape[1] = 2;	  // the transformation matrix height 2
	dTheta_tmp_shape[2] = 3;	  // the transformation matrix width 3
	dTheta_tmp_shape[3] = output_H_ * output_W_ * C;  // output tensor size per instance
	...
	full_theta_shape[1] = 6;	  // the number of parameters
